 ...
 */
void Referee::Init(UART_HandleTypeDef *huart, uint8_t __Frame_Header)
{
    if (huart->Instance == USART1)
    {
        uart_manage_object_ = &g_uart1_manage_object;
    }
    else if (huart->Instance == USART2)
    {
        uart_manage_object_ = &g_uart2_manage_object;
    }
    else if (huart->Instance == USART3)
    {
        uart_manage_object_ = &g_uart3_manage_object;
    }
    else if (huart->Instance == UART4)
    {
        uart_manage_object_ = &g_uart4_manage_object;
    }
    else if (huart->Instance == UART5)
    {
        uart_manage_object_ = &g_uart5_manage_object;
    }
    else if (huart->Instance == USART6)
    {
        uart_manage_object_ = &g_uart6_manage_object;
    }
    else if (huart->Instance == UART7)
    {
        uart_manage_object_ = &g_uart7_manage_object;
    }
    else if (huart->Instance == UART8)
    {
        uart_manage_object_ = &g_uart8_manage_object;
    }
...
void Referee::UartSendInteractionUiGraphic1(RefereeDataInteractionGraphicConfig *Graphic_1)
{
    ...
    HAL_UART_Transmit(uart_manage_object_->uart_handler, (uint8_t *) tmp_buffer, 7 + sizeof(RefereeTxDataInteractionGraphic1), 100);
...
void Referee::UartSendInteractionUiGraphic2(RefereeDataInteractionGraphicConfig *Graphic_1, RefereeDataInteractionGraphicConfig *Graphic_2)
{
    ...
    HAL_UART_Transmit(uart_manage_object_->uart_handler, (uint8_t *) tmp_buffer, 7 + sizeof(RefereeTxDataInteractionGraphic2), 100);
...
void Referee::UartSendInteractionUiGraphic5(RefereeDataInteractionGraphicConfig *Graphic_1, RefereeDataInteractionGraphicConfig *Graphic_2, RefereeDataInteractionGraphicConfig *Graphic_3, RefereeDataInteractionGraphicConfig *Graphic_4, RefereeDataInteractionGraphicConfig *Graphic_5)
{
    ...
    HAL_UART_Transmit(uart_manage_object_->uart_handler, (uint8_t *) tmp_buffer, 7 + sizeof(RefereeTxDataInteractionGraphic5), 100);
...
void Referee::UartSendInteractionUiGraphic7(RefereeDataInteractionGraphicConfig *Graphic_1, RefereeDataInteractionGraphicConfig *Graphic_2, RefereeDataInteractionGraphicConfig *Graphic_3, RefereeDataInteractionGraphicConfig *Graphic_4, RefereeDataInteractionGraphicConfig *Graphic_5, RefereeDataInteractionGraphicConfig *Graphic_6, RefereeDataInteractionGraphicConfig *Graphic_7)
{
    ...
    HAL_UART_Transmit(uart_manage_object_->uart_handler, (uint8_t *) tmp_buffer, 7 + sizeof(RefereeTxDataInteractionGraphic7), 100);
...
void Referee::UartSendInteractionUiGraphicString(RefereeDataInteractionGraphicConfig *Graphic_String, const char *String_Content)
{
    ...
    HAL_UART_Transmit(uart_manage_object_->uart_handler, (uint8_t *) tmp_buffer, 7 + sizeof(RefereeTxDataInteractionGraphicString), 80);
...
void Referee::AlivePeriodElapsedCallback()
{
    ...
    if (flag_ == pre_flag_)
    {
        ...
        uart_reinit(uart_manage_object_->uart_handler);
    }
    else
    {
        // 裁判系统保持连接
