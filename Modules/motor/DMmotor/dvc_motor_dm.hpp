...
#include "bsp_can.h"
#include "../../algorithm/math/alg_math.hpp"
...
public:
  void Init(FDCAN_HandleTypeDef *hcan,
    ...
    inline enum Enum_Motor_DM_Status Get_Status();

    inline enum Enum_Motor_DM_Control_Status_Normal Get_Control_Status();
    ...
    inline enum Enum_Motor_DM_Control_Method Get_Control_Method();
...
public:
    ...
    void Init(FDCAN_HandleTypeDef *hcan,
              enum Enum_Motor_DM_Motor_ID_1_To_4 __CAN_Rx_ID,
              enum Enum_Motor_DM_Control_Method __Motor_DM_Control_Method =
                  Motor_DM_Control_Method_1_TO_4_ANGLE,
    ...
    inline void Set_Control_Method(enum Enum_Motor_DM_Control_Method __DM_Motor_Control_Method);
...
protected:
    ...
    enum Enum_Motor_DM_Motor_ID_1_To_4 CAN_Rx_ID;
    // 编码器偏移
    ...
    // 电机状态
    enum Enum_Motor_DM_Status Motor_DM_Status = Motor_DM_Status_DISABLE;
    // 电机对外接口信息
    ...
    // 电机控制方式
    enum Enum_Motor_DM_Control_Method Motor_DM_Control_Method = Motor_DM_Control_Method_1_TO_4_ANGLE;
    // 目标的角度
